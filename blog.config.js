...
const BLOG = {
  AUTHOR: 'rt23456p', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'google.com', // 网站地址
  KEYWORDS: 'rt23456p', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'a101b531756e48d0a0b766852872ce91', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
